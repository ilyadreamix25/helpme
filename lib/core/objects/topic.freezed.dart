...
abstract class $TopicCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, bool isReadOnly, int createdAt});
}
...
class _$_Topic implements _Topic {
  ...
  @override
  String toString() {
    return 'Topic(id: $id, name: $name, isReadOnly: $isReadOnly, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, isReadOnly, createdAt);
...
abstract class _Topic implements Topic {
  const factory _Topic(
      ...
      required final int createdAt}) = _$_Topic;
